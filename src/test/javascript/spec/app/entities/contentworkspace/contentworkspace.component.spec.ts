...
import { ContentworkspaceComponent } from 'app/entities/contentworkspace/contentworkspace.component';
...
describe('Component Tests', () => {
  describe('Contentworkspace Management Component', () => {
    let comp: ContentworkspaceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContentworkspaceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contentworkspaces && comp.contentworkspaces[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
